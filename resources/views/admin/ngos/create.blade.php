                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="receiver_type" id="receiver_type" required
                                    ...
                                    <option value="ngo" {{ old('receiver_type') == 'ngo' ? 'selected' : '' }}>NGO</option>
                                    <option value="volunteer" {{ old('receiver_type') == 'volunteer' ? 'selected' : '' }}>Volunteer</option>
                                    <option value="shelter" {{ old('receiver_type') == 'shelter' ? 'selected' : '' }}>Shelter</option>
                                </select>
                            </div>
