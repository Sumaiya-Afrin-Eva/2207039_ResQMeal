                    ...
                    <form action="{{ route('admin.donations.update', $donation->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="food_name" id="food_name" value="{{ old('food_name', $donation->food_name) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="category" id="category" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    ...
                                    <option value="Cooked" {{ old('category', $donation->category) == 'Cooked' || old('category', strtolower($donation->category)) == 'cooked' ? 'selected' : '' }}>Cooked</option>
                                    <option value="Raw" {{ old('category', $donation->category) == 'Raw' || old('category', strtolower($donation->category)) == 'raw' ? 'selected' : '' }}>Raw/Uncooked</option>
                                    <option value="Packaged" {{ old('category', $donation->category) == 'Packaged' || old('category', strtolower($donation->category)) == 'packaged' ? 'selected' : '' }}>Packaged/Canned</option>
                                </select>
                            </div>

                            <div>
                                <label for="quantity" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Quantity *</label>
                                <input type="number" step="0.01" name="quantity" id="quantity" value="{{ old('quantity', $donation->quantity) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="unit" id="unit" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    ...
                                    <option value="kg" {{ old('unit', strtolower($donation->unit)) == 'kg' ? 'selected' : '' }}>Kilograms (kg)</option>
                                    <option value="liters" {{ old('unit', strtolower($donation->unit)) == 'liters' ? 'selected' : '' }}>Liters</option>
                                    <option value="units" {{ old('unit', strtolower($donation->unit)) == 'units' ? 'selected' : '' }}>Units / Pieces</option>
                                    <option value="boxes" {{ old('unit', strtolower($donation->unit)) == 'boxes' ? 'selected' : '' }}>Boxes</option>
                                </select>
                            </div>

                            <div>
                                <label for="serves" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Serves (Number of People) *</label>
                                <input type="number" name="serves" id="serves" value="{{ old('serves', $donation->serves) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>

                            <div>
                                <label for="expiry" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Expiry Date & Time *</label>
                                <input type="datetime-local" name="expiry" id="expiry" value="{{ old('expiry', \Carbon\Carbon::parse($donation->expiry)->format('Y-m-d\TH:i')) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="pickup_from" id="pickup_from" value="{{ old('pickup_from', \Carbon\Carbon::parse($donation->pickup_from)->format('Y-m-d\TH:i')) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>

                            <div>
                                <label for="pickup_to" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Pickup Window End *</label>
                                <input type="datetime-local" name="pickup_to" id="pickup_to" value="{{ old('pickup_to', \Carbon\Carbon::parse($donation->pickup_to)->format('Y-m-d\TH:i')) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>

                            <div class="md:col-span-2">
                                <label for="pickup_address" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Pickup Address *</label>
                                <input type="text" name="pickup_address" id="pickup_address" value="{{ old('pickup_address', $donation->pickup_address) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>

                            <div class="md:col-span-2">
                                <label for="pickup_contact" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Pickup Contact Number *</label>
                                <input type="text" name="pickup_contact" id="pickup_contact" value="{{ old('pickup_contact', $donation->pickup_contact) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="storage" id="storage" value="{{ old('storage', $donation->storage) }}" placeholder="e.g. Keep refrigerated" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>

                            <div>
                                <label for="packaging" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Packaging Type</label>
                                <input type="text" name="packaging" id="packaging" value="{{ old('packaging', $donation->packaging) }}" placeholder="e.g. Plastic boxes" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>

                            <div>
                                <label for="allergens" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Allergens</label>
                                <input type="text" name="allergens" id="allergens" value="{{ old('allergens', $donation->allergens) }}" placeholder="e.g. Contains nuts, dairy" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>

                            <div>
                                <label for="dietary" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Dietary Specifications</label>
                                <input type="text" name="dietary" id="dietary" value="{{ old('dietary', $donation->dietary) }}" placeholder="e.g. Halal, Vegan" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>

                            <div class="md:col-span-2">
                                <label for="notes" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Additional Notes</label>
                                <textarea name="notes" id="notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('notes', $donation->notes) }}</textarea>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="number" name="donor_id" id="donor_id" value="{{ old('donor_id', $donation->donor_id) }}" placeholder="Enter ID to link an existing Donor" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <p id="donor_status_msg" class="text-sm mt-1 text-gray-500">Type an ID to check database.</p>
                                <input type="hidden" name="donor_name" id="hidden_donor_name" value="{{ old('donor_name', $donation->donor_name) }}">
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-2 space-y-2">
                                    <div class="flex items-center">
                                        <input type="radio" name="visibility" id="visibility_1" value="1" {{ old('visibility', $donation->visibility ?? '1') == '1' || strtolower(old('visibility', $donation->visibility)) == 'all' ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="visibility_1" class="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300">Visible to Public</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="radio" name="visibility" id="visibility_0" value="0" {{ old('visibility', $donation->visibility) == '0' || strtolower(old('visibility', $donation->visibility)) == 'hidden' ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                            ...
                            <div>
                                ...
                                <div class="mt-2 space-y-2">
                                    <div class="flex items-center">
                                        <input type="radio" name="emergency" id="emergency_1" value="1" {{ old('emergency', $donation->emergency) == '1' ? 'checked' : '' }} class="focus:ring-red-500 h-4 w-4 text-red-600 border-gray-300">
                                    ...
                                    <div class="flex items-center">
                                        <input type="radio" name="emergency" id="emergency_0" value="0" {{ old('emergency', $donation->emergency ?? '0') == '0' ? 'checked' : '' }} class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                        ...
                        <div class="mt-8 flex justify-end space-x-3">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Update Donation</button>
                        </div>
